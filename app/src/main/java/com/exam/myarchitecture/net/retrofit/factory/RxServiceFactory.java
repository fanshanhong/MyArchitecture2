package com.exam.myarchitecture.net.retrofit.factory;
...
import com.exam.myarchitecture.net.retrofit.cookies.CookieManger;
...
//        okBuilder.cache(new Cache(httpCacheDirectory, 10 * 1024 * 1024));
        ...
        //设置超时时间
        okBuilder.connectTimeout(ServerConstant.DEFAULT_TIMEOUT, TimeUnit.SECONDS);
        okBuilder.writeTimeout(ServerConstant.DEFAULT_TIMEOUT, TimeUnit.SECONDS);
        okBuilder.readTimeout(ServerConstant.DEFAULT_TIMEOUT, TimeUnit.SECONDS);
